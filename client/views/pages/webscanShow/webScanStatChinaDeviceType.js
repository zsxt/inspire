Template.webScanStatChinaDeviceType.onCreated(function() {
...
Template.webScanStatChinaDeviceType.onRendered(function() {

    var chart = echarts.init(document.getElementById('webScanStatChinaDeviceType'));
    var chartOptions = {
        tooltip : {
            trigger: 'item',
    ...
    this.autorun(function() {
        var findData = Inspire.Collection.WebScanStatChinaStat.find({attr: "devicetype"}).fetch();
