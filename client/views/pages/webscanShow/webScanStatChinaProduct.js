Template.webScanStatChinaProduct.onCreated(function() {
...
Template.webScanStatChinaProduct.onRendered(function() {

    var chart = echarts.init(document.getElementById('webScanStatChinaProductChart'));
    var chartOptions = {
    ...
    this.autorun(function() {
        var findData = Inspire.Collection.WebScanStatChinaStat.find({attr: "product"}).fetch();
        var polarIndicator = [];
        var dataValue = [];
        var maxValue = 0;
