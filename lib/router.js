...
Router.route('/industryTrend', function () {
    this.render('industryTrend');
});
...
Router.route('/icpAnalysis', {
  ...
  //   this.subscribe('other_data', {context: 'zt', attr: 'BBFS', limit: 10, start: '2010-10-11', end: '2012-11-11'})
  //   this.subscribe('other_data', {context: 'zt', attr: 'LRYHLX', limit: 10, start: '2010-10-11', end: '2012-11-11'}).wait()
  // }
  waitOn: function() {
    // return Meteor.subscribe('other_data2')
    return [
      Meteor.subscribe('other_data', {context: 'zt', attr: 'BBFS', limit: 10, start: '2010-10-11', end: '2012-11-11'}),
      Meteor.subscribe('other_data', {context: 'zt', attr: 'LRYHLX', limit: 10, start: '2010-10-11', end: '2012-11-11'}),
      Meteor.subscribe('other_data', {context: 'wz', attr: 'LRYHLX', limit: 10, start: '2010-10-11', end: '2012-11-11'}),
      Meteor.subscribe('other_data', {context: 'ymlb', attr: 'POSTFIX', limit: 10, start: '2010-10-11', end: '2012-11-11'}),
      Meteor.subscribe('other_data', {context: 'ip', attr: 'SFGN', limit: 10, start: '2010-10-11', end: '2012-11-11'}),
      Meteor.subscribe('other_data', {context: 'ip', attr: 'FPFS', limit: 10, start: '2010-10-11', end: '2012-11-11'}),
      Meteor.subscribe('other_data', {context: 'ip', attr: 'IP_LX', limit: 10, start: '2010-10-11', end: '2012-11-11'}),
    ]
    // return Meteor.subscribe('other_data', {context: 'zt', attr: 'BBFS', limit: 10, start: '2010-10-11', end: '2012-11-11'})
  }
});
